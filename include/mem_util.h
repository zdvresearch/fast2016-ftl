...
#define mem_search_equ_4_bytes(ADDR, SIZE, CMD, VAL)      _mem_search_equ_4_bytes((void*) (ADDR),  (UINT32) (SIZE), (UINT32) (CMD), (UINT32) (VAL))
#define mem_search_equ_sram_4_bytes(ADDR, SIZE, VAL)      mem_search_equ_4_bytes(ADDR, SIZE, MU_CMD_SEARCH_EQU_SRAM, VAL)
#define mem_search_equ_dram_4_bytes(ADDR, SIZE, VAL)      mem_search_equ_4_bytes(ADDR, SIZE, MU_CMD_SEARCH_EQU_DRAM, VAL)
...
UINT32 _mem_search_equ_4_bytes(const void* const addr, UINT32 const size, UINT32 const cmd, UINT32 const val);
...
//#define read_dram_32(ADDR)                      (*(volatile UINT32*)(DRAM_BASE + ((UINT32)ADDR - DRAM_BASE)/128*132 + ((UINT32)ADDR - DRAM_BASE)%128))
// note(fabio): I tried this optimization, but it does not give noticeable benefits, although using the _read_dram_32 function causes one more jump.

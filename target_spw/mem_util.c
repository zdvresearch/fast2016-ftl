...
UINT32 _mem_search_equ_4_bytes(const void* const addr,  UINT32 const num_items, UINT32 const cmd, UINT32 const val)
{
    ...
    UINT32 retval = GETREG(MU_RESULT);
